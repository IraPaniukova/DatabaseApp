...
public partial class DadIraContext : DbContext
{
    public DadIraContext()
    {
    }

    public DadIraContext(DbContextOptions<DadIraContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=***;Initial Catalog=***;Persist Security Info=True;User ID=***;Password=***;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TruckCustomer>(entity =>
        {
            ...
            entity.HasOne(d => d.Customer).WithOne(p => p.TruckCustomer)
        ...
        modelBuilder.Entity<TruckEmployee>(entity =>
        {
            ...
            entity.HasOne(d => d.Employee).WithOne(p => p.TruckEmployee)
        ...
        modelBuilder.Entity<TruckRental>(entity =>
        {
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.TruckRentals)
                .HasForeignKey(d => d.CustomerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TruckRental_TruckCustomer");

            entity.HasOne(d => d.Truck).WithMany(p => p.TruckRentals)
